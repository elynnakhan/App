...
class Products(db.Base):
    ...
    ProductCategoryID = Column(Integer, ForeignKey('ProductCategory.CategoryID'))  
...
class Sales(db.Base):
    ...
    SalespersonID = Column(Integer, ForeignKey('Users.UserID')) 
...
class InventoryRecords(db.Base):
    ...
    PersonResponsibleID = Column(Integer, ForeignKey('Users.UserID'))  
